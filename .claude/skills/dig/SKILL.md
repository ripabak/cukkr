...
description: |
  ...
  When to use: (1) When plan details are unclear (2) Before implementation to nail down requirements
  Trigger keywords: ambiguous, unclear, requirements check, dig
metadata:
  version: "2.0.0"
