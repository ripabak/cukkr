...
> **Monorepo note:** Issues may span `cukkr-backend`, `cukkr-frontend`, or both. Tag issues with the relevant package label (`backend`, `frontend`) and group tasks by package where applicable.
