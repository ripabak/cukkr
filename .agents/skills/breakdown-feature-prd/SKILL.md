...
description: 'Prompt for creating Product Requirements Documents (PRDs) for new features, based on an Epic. Works for backend, frontend, or full-stack features in a monorepo.'
---
...
- **Package Scope:** Indicate which package(s) this feature touches — `cukkr-backend`, `cukkr-frontend`, or both.
...
- **Package Scope:** [Optional: backend / frontend / full-stack]